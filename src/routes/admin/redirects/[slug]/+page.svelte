<script lang="ts">
	...
	const redirectItem = $derived(data.redirect);
</script>

<div class="container mx-auto px-4 py-8 max-w-2xl">
	<h1 class="text-3xl font-bold mb-6">Edit Redirect</h1>
	...
	<form method="POST" use:enhance class="space-y-6">
		...
		<div>
			...
			<textarea
				...
				rows="3"
				class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-hacksu-green"
			>{redirectItem.description}</textarea
			>
		</div>
