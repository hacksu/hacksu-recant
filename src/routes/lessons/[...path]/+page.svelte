		...
		<div class="max-w-[1200px] mx-auto relative">
			...
			{#if showSearchResults}
				<div class="mt-8">
					...
					{:else}
						<div
							class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-8 max-w-[1200px]"
						>
			...
			{:else}
				...
				{:else if lessonsBySubcategory.subcategoryGroups.length > 0 || lessonsBySubcategory.directLessons.length > 0}
					...
					{#each lessonsBySubcategory.subcategoryGroups as group}
						<div class="mt-12 first:mt-0">
							...
							<div
								class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-[1200px]"
							>
				...
				{:else if groupedItems.categories.length > 0}
					...
					<div
						class="grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] md:grid-cols-1 gap-6 mt-8"
					>
